...
export function Blogitemleft(props) {
    return (
        <div className={"container-left"}>
            <h1 className={"text-no"}> Under this image could be text related to the announcement of an artist for the coming ivent.
            ...
            <img className={"image-no"} src={props.image}/>
        </div>
    );
}
